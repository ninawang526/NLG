...
AVG_EVERYWHERE_MSG = {"other":["you spoke at an average of %d WPM in this recording",
"you spoke at a overall pace of %d WPM in this recording",
"your overall pace in this recording was %d WPM"],
"normal":["you spoke at a nice, balanced pace of %d WPM in this recording"]}
...
"you should also think generally about how your tone fits in with the content of what you're saying. If you were to sum up your message in just one word, what would it be? Do you feel that your tone properly express this message?",
...
"a faster pace is good for encouragement, while a slower one will be better for persuasion",
...
OVERALL_MSG = [
"overall, this recording was likely much too fast for any audience -- a wall of words. Speaking too quickly makes it \
difficult to have a \"conversation\" with the audience, and you're much more likely to \
make mistakes",

"overall, this recording was likely to be too fast for any audience over 30 people. \
...
especially very large audiences or a speech delivered in open air. It was good for solemn/painful/difficult \
occasions, or for conveying humorous exaggeration. You showed respect \
